...
typedef struct SensorData1 {
	int IRSensor[6]; int TorqueSensor[2];
	int TemperatureSensor; int CDSSensor;
	int GSensor[3]; int MSensor[3]; int GySensor[3];
	int SteeringVar; int SteeringTorque;
	int Battery; int Remote; int MTemperature;
}SensorData;
